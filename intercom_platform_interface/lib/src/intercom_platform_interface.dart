...
import 'package:intercom_platform_interface/src/intercom_status_callback.dart';
import 'package:plugin_platform_interface/plugin_platform_interface.dart';

enum IntercomVisibility { gone, visible }

abstract class IntercomPlatform extends PlatformInterface {
  /// Constructs a IntercomPlatformInterfacePlatform.
  IntercomPlatform() : super(token: _token);

  static final Object _token = Object();

  static IntercomPlatform _instance = _PlaceholderImplementation();

  /// The default instance of [IntercomPlatform] to use.
  ///
  /// Defaults to [MethodChannelIntercomPlatformInterface].
  static IntercomPlatform get instance => _instance;

  /// Platform-specific plugins should set this with their own platform-specific
  static set instance(IntercomPlatform instance) {
  ...
  Future<void> setLauncherVisibility(IntercomVisibility visibility) {
    throw UnimplementedError('setLauncherVisibility() has not been implemented.');
  }
  ...
  Future<int> unreadConversationCount() {
    throw UnimplementedError('unreadConversationCount() has not been implemented.');
  }
  ...
  Future<void> setInAppMessagesVisibility(IntercomVisibility visibility) {
    throw UnimplementedError('setInAppMessagesVisibility() has not been implemented.');
  }
  ...
  Future<void> displayHelpCenterCollections(List<String> collectionIds) {
    throw UnimplementedError('displayHelpCenterCollections() has not been implemented.');
  }
  ...
  Future<void> displayMessageComposer(String message) {
    throw UnimplementedError('displayMessageComposer() has not been implemented.');
  }
  ...
  Future<void> handlePush(Map<String, String> message) async {
  ...
  @protected
  IntercomError convertExceptionToIntercomError(PlatformException e) {
    var details = e.details ?? {};

    return IntercomError(details['errorCode'] ?? -1, details['errorMessage'] ?? e.message ?? '');
  }
}

class _PlaceholderImplementation extends IntercomPlatform {}
